...
##Product Module
a. Create Product List Functionlaity
b. Search products within Store

##Reviews Module
1. Bold the Max Count of Review

Product has already the meta keywords & description.
a. Meta Keywords -populates -->"category, subcategory, subcategory city,
b. store owner name city, product name city" & then store owners adds it.
c. Meta Description: if not added would be 50 words of product description.